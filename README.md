...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">工程投标项目管理办公系统V2.0.2</h1>
...
## 使用文档
* 文档地址： [http://item.doc.xnqys.cn/pms/](http://item.doc.xnqys.cn/pms/)
...
<table>
    ...
    <tr>
     ...
     <tr>
        <td style="width: 200px;">完善移动端预算、投标、合同、采购模块；修复管理端采购模块使用组件关联调用项目列表</td>
        <td>2025-03-18</td>
    </tr>
     <tr>
    ...
    <tr>
        <td>修复投标信息、项目合同、采购管理、施工进度、质量管理、验收管理关联的列表项目组件问题</td>
        <td>2025-02-27</td>
    </tr>
    <tr>
        <td>完善成本管理模块</td>
